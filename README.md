...
* в админ-панели реализована возможность удаления пользователя. При этом удаляется не только сам пользователь, но и все слова, созданные им, и все списки, в которые входили удаленные слова
